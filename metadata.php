...
$aModule = [
    ...
    'extend'                  => [
        ...
        OxidEsales\Eshop\Application\Controller\ForgotPasswordController::class => ITholics\Oxid\BasicCaptcha\Application\Controller\ForgotPasswordController::class,
        OxidEsales\Eshop\Application\Controller\InviteController::class         => ITholics\Oxid\BasicCaptcha\Application\Controller\InviteController::class,
    ...
    'blocks'                  => [
        ...
        ['template' => 'form/privatesales/invite.tpl', 'block' => 'captcha_form', 'file' => '/Application/views/blcoks/ith_basic_captch_form.tpl'],
        ['template' => 'form/pricealarm.tpl', 'block' => 'captcha_form', 'file' => '/Application/views/blcoks/ith_basic_captch_form.tpl'],
        ['template' => 'form/forgotpwd_email.tpl', 'block' => 'captcha_form', 'file' => '/Application/views/blcoks/ith_basic_captch_form.tpl']
    ],
    'events'                  => [
